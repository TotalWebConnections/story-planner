...
(defmethod handle-websocket-message "create-folder"
  [data]
  (generate-string (DB-projects/create-folder {:name (:value data) :type (:folder data) :id (:projectId data)} (:_id (:user data)))))
(defmethod handle-websocket-message "create-entity"
  [data]
  (generate-string (DB-projects/create-entity (dissoc data :channel) (:_id (:user data)))))
(defmethod handle-websocket-message "create-board"
  [data]
  (generate-string (DB-projects/create-board (dissoc data :channel) (:_id (:user data)))))
(defmethod handle-websocket-message "create-storypoint"
  [data]
  (generate-string (DB-projects/create-storypoint (dissoc data :channel) (:_id (:user data)))))
...
(defmethod handle-websocket-message "update-storypoint-position"
  [data] ; Returns the name and ID of all projects
  (generate-string (DB-projects/update-storypoint-position {:storypointId (:storypointId data) :position (:position data) :size (:size data) :id (:projectId data)} (:_id (:user data)))))
(defmethod handle-websocket-message "update-storypoint-title"
  [data] ; Returns the name and ID of all projects
  (generate-string (DB-projects/update-storypoint-title {:id (:projectId data) :storypointId (:storypointId data) :value (:value data)} (:_id (:user data)))))
(defmethod handle-websocket-message "update-storypoint-description"
  [data] ; Returns the name and ID of all projects
  (generate-string (DB-projects/update-storypoint-description {:id (:projectId data) :storypointId (:storypointId data) :value (:value data)} (:_id (:user data)))))
(defmethod handle-websocket-message "add-link-to-storypoint"
  [data]
  (generate-string (DB-projects/add-link-to-storypoint {:id (:projectId data) :storypointId (:storypointId data) :value (:value data)} (:_id (:user data)))))
(defmethod handle-websocket-message "update-link-label"
  [data]
  (generate-string (DB-projects/update-link-label {:id (:projectId data) :storypointId (:storypointId data) :linkId (:linkId data) :label (:label data)} (:_id (:user data)))))
(defmethod handle-websocket-message "delete-storypoint"
  [data]
  (generate-string (DB-projects/delete-storypoint {:id (:projectId data) :storypointId (:storypointId data)} (:_id (:user data)))))
